...
import WordOfTheWeek from "@/components/WordOfTheWeek" // Ensure the path is correct
...
<section className="relative min-h-fit md:min-h-[600px] flex items-center justify-center bg-gradient-to-br from-primary to-primary-light text-white overflow-hidden py-16 md:py-0">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <img
              src="/logo.png"
              alt="PCLDRC Logo"
              className="w-20 h-20 sm:w-32 sm:h-32 mx-auto rounded-full shadow-2xl"
            />
          </motion.div>

          <motion.h1 
            className="font-serif text-4xl sm:text-6xl font-bold mb-4 text-balance leading-tight" 
            {...fadeInUp}
          >
          ...
          <motion.p
            className="text-lg sm:text-2xl font-semibold mb-2 text-accent"
            {...fadeInUp}
          ...
          <motion.p
            className="text-base sm:text-lg text-gray-100 mb-8 max-w-2xl mx-auto text-balance"
            {...fadeInUp}
          ...
          >
            <Link
              href="/submit-blog"
              className="w-full sm:w-auto px-6 py-3 bg-accent hover:bg-accent-light text-primary font-semibold rounded-lg transition-smooth text-center"
            >
              Submit a Blog
            </Link>
            <Link
              href="/gallery"
              className="w-full sm:w-auto px-6 py-3 bg-primary-light hover:bg-primary font-semibold text-white rounded-lg transition-smooth border border-white/20 text-center"
            >
              View Events
            </Link>
            <Link
              href="/contact"
              className="w-full sm:w-auto px-6 py-3 border-2 border-white hover:bg-white/10 text-white font-semibold rounded-lg transition-smooth text-center"
            >
              Get in Touch
            </Link>
          </motion.div>
